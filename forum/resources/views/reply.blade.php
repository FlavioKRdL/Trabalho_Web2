...
<header class="header1">
    ...
    <br>
    @guest
        <h1>Você deve estar logado para responder a um post</h1>
    @endguest
    ...
    <form action="/reply/{{$id}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="post-box">
            <label for="post_id">Respondendo ao post: </label>
            <input type="number" name="post_id" id="post_id" readonly value="{{$id}}">
            <br>
